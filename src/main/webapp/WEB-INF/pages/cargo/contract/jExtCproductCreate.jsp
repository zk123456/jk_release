    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent" colspan="3"><input type="text" name="orderNo" value=""/></td>	            
	        </tr>		
	        <tr>
	            ...
	            <td class="tableContent">
	            	<select name="ctype">
	            		...
	            		<option value="${ctype.orderNo}">${ctype.name}</option>
	            		</c:forEach>
	            	</select>
				</td>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.amount}</td>
		<td>
			<a href="toupdate.action?id=${o.id}&contractProductId=${o.id}">[修改]</a>
