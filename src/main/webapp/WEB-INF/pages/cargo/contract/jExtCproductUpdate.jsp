...
<head>
    ...
    <script language="javascript">
    	//设置生产厂家简称隐藏域
    	function setFactoryNameHidden(value){
    		var factoryName = document.getElementById("factoryName");
    		factoryName.value = value;
    	}
    </script>
</head>
<body>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent" colspan="3"><input type="text" name="orderNo" value="${obj.orderNo}"/></td>	            
	        </tr>		
	        <tr>
	            ...
	            <td class="tableContent">
	            	<select name="ctype">
	            		...
	            		<option value="${ctype.orderNo}" <c:if test="${obj.ctype==ctype.orderNo}">selected</c:if>>${ctype.name}</option>
	            		</c:forEach>
	            	</select>
				</td>	        
	            <td class="columnTitle">生产厂家：</td>
	            <td class="tableContent">
	            	<select name="factoryId" onchange="setFactoryNameHidden(this.options[this.selectedIndex].text);">
	            		<option value="--请选择--"></option>
